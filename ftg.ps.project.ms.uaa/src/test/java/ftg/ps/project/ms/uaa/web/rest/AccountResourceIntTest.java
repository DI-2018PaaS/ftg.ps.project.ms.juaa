package ftg.ps.project.ms.uaa.web.rest;

import ftg.ps.project.ms.uaa.config.Constants;
import ftg.ps.project.ms.uaa.PsUaaApp;
import ftg.ps.project.ms.uaa.domain.Authority;
import ftg.ps.project.ms.uaa.domain.User;
import ftg.ps.project.ms.uaa.repository.AuthorityRepository;
import ftg.ps.project.ms.uaa.repository.UserRepository;
import ftg.ps.project.ms.uaa.security.AuthoritiesConstants;
import ftg.ps.project.ms.uaa.service.MailService;
import ftg.ps.project.ms.uaa.service.dto.UserDTO;
import ftg.ps.project.ms.uaa.service.dto.PasswordChangeDTO;
import ftg.ps.project.ms.uaa.web.rest.errors.ExceptionTranslator;
import ftg.ps.project.ms.uaa.web.rest.vm.KeyAndPasswordVM;
import ftg.ps.project.ms.uaa.web.rest.vm.ManagedUserVM;
import ftg.ps.project.ms.uaa.service.UserService;
...
@SpringBootTest(classes = PsUaaApp.class)
