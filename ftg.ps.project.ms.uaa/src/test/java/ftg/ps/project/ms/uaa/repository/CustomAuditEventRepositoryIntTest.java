package ftg.ps.project.ms.uaa.repository;

import ftg.ps.project.ms.uaa.PsUaaApp;
import ftg.ps.project.ms.uaa.config.Constants;
import ftg.ps.project.ms.uaa.config.audit.AuditEventConverter;
import ftg.ps.project.ms.uaa.domain.PersistentAuditEvent;
...
import static ftg.ps.project.ms.uaa.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
